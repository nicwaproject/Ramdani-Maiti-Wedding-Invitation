document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('coupleNames').textContent = coupleNames || 'Ramdani & Maiti'; // Default names
...
function calculateCountdown() {
    const weddingDate = new Date('2024-10-05T09:00:00'); // Set your wedding date and time here (e.g., 3:00 PM)
...
// messages handler
    ...
    if (messageForm) {
        messageForm.addEventListener('submit', function(e) {
            ...
            fetch('https://ramdani-maiti.glitch.me/messages', {
                method: 'POST',
                headers: {
